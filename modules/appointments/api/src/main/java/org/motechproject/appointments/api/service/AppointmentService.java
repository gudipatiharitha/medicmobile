...
public interface AppointmentService {
    ...
    /**
     * Remove the mark on visit/appointment as missed.
     *
     * @param externalId identifies user
     * @param visitName  unique visit id for the user
     */
    void removeVisitAsMissed(String externalId, String visitName);
    ...
    List<VisitResponse> getResponseAnganwadiCenter(String property, String value, boolean missed, DateTime dueDate);
}
