...
public class KookooIvrControllerTest {
    ...
    public void shouldRenderKookooNodeRespone() {
        ...
        when(decisionTreeServer.getResponse("123a", "1234567890", "kookoo", "sometree", null, "en", false)).thenReturn(view);
   ...
   /* @Test
    public void shouldRenderKookooNodeRespone() {
        ...
        view = decisionTreeServer.getResponse("123a", "1234567890", "kookoo", "sometree", null, "en");
        view.addObject("contextPath", "contextPath");
        view.addObject("servletPath", "servletPath");
        view.addObject("host", "host");
        view.addObject("scheme", "scheme");
        view.addObject("isInboundCall", false);
        assertEquals(kookooIvrController.getOutPutString(view), kookooIvrController.ivrCallback(request, new MockHttpServletResponse()));
    }
*/
    @Test
    ...
    public void shouldUpdateSessionWithKookooSidForOutgoingCallback() {
        ...
        ModelAndView view = new ModelAndView();
        when(decisionTreeServer.getResponse("456b", "1234567890", "kookoo", "sometree", null, "en", false)).thenReturn(view);
